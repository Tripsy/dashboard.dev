...
import { ViewPlace } from '@/app/(dashboard)/dashboard/places/view-place.component';
import type {
...
> = {
	...
	actions: {
		...
		update: {
			...
			reloadEntry: (id: number) => requestView<PlaceModel>('places', id),
			buttonPosition: 'left',
			button: {
				variant: 'outline',
				hover: 'success',
