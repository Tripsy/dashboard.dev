...
import { FormManageCompanyVehicle } from '@/app/(dashboard)/dashboard/company-vehicles/form-manage-company-vehicle.component';
import { StatusTransitionCompanyVehicle } from '@/app/(dashboard)/dashboard/company-vehicles/status-transition-company-vehicle.component';
import { ViewCompanyVehicle } from '@/app/(dashboard)/dashboard/company-vehicles/view-company-vehicle.component';
import type {
...
export type CompanyVehiclesDataTableFiltersType = {
	...
	actions: {
		...
		delete: {
			...
			operationFunction: (entry: CompanyVehicleModel) =>
				requestDelete('company-vehicles', entry),
			buttonPosition: 'left',
			button: {
				variant: 'outline',
				hover: 'error',
		...
		restore: {
			...
			operationFunction: (entry: CompanyVehicleModel) =>
				requestRestore('company-vehicles', entry),
			buttonPosition: 'left',
			button: {
				variant: 'outline',
				hover: 'info',
