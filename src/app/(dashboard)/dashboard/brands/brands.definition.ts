...
import { ViewBrand } from '@/app/(dashboard)/dashboard/brands/view-brand.component';
import type {
...
> = {
	dataTable: {
		...
		find: (params: FindFunctionParamsType) =>
			requestFind<BrandModel>('brands', params),
	},
	...
	actions: {
		...
		update: {
			...
			reloadEntry: (id: number) => requestView<BrandModel>('brands', id),
			buttonPosition: 'left',
			button: {
				variant: 'outline',
				hover: 'success',
		...
		enable: {
			...
			operationFunction: (entry: BrandModel) =>
				requestUpdateStatus('brands', entry, 'active'),
			buttonPosition: 'left',
			button: {
				variant: 'outline',
				hover: 'info',
		...
		disable: {
			...
			operationFunction: (entry: BrandModel) =>
				requestUpdateStatus('brands', entry, 'inactive'),
			buttonPosition: 'left',
			button: {
				variant: 'outline',
				hover: 'error',
